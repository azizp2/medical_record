...
<form id="form-data-triase">
    ...
    <div class="tab-content">
        <!-- Info Pasien -->
        <div class="tab-pane p-3 <?= $fragment == 'assesmen' ? 'active' : '' ?> " id="assesmen" role="">
        ...
        <div class="tab-pane  <?= $fragment == 'skreningNyeri' ? 'active' : '' ?> p-3" id="skreningNyeri" role="">
            <span class="d-block mt-3"></span>
        ...
        <div class="tab-pane  <?= $fragment == 'resikoJatuh' ? 'active' : '' ?> p-3" id="resikoJatuh" role="">
            <span class="d-block mt-3"></span>
        ...
        <div class="tab-pane <?= $fragment == 'serahTerima' ? 'active' : '' ?> p-3" id="serahTerima" role="">
            <span class="d-block mt-3"></span>
